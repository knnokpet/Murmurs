...
typedef enum MBResponseType {
    ...
    MBTwitterListResponse = 4,
    MBTwitterListsResponse = 5,
    MBTwitterDirectMessagesResponse = 6,
    MBTwitterDirectMessageResponse = 7,
    MBTwitterGeocodeResponse = 8,
    MBTwitterHelpResponse = 9,
} MBResponseType;
